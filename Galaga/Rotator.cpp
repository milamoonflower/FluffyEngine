...
Rotator::Rotator(Fluffy::GameObject* pOwner, const float angleDegrees, const glm::vec2& center)
...
Rotator::Rotator(Fluffy::GameObject* pOwner, const float angleDegrees, const float centerX, const float centerY)
	: Fluffy::Component(pOwner)
	, m_RotationAngleDegrees{ angleDegrees }
